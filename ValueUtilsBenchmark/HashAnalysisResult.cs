...
namespace ValueUtilsBenchmark
{
    class HashAnalysisResult
    {
        ...
        public XElement ToTableRow() => new XElement("tr",
        ...
        public static XElement ToTableHead(string title) => new XElement("thead",
            new XElement("tr",
                new XElement("th",
        ...
        public static XElement ToTable(string title, IEnumerable<HashAnalysisResult> results) => new XElement("table",
            ToTableHead(title),
            new XElement("tbody",
